...
SIGNAL \gd|disp2[1]~4_combout\ : std_logic;
...
-- Equation(s):
-- \f|Equal0~7_combout\ = (\f|ctr\(1) & (\f|ctr\(0) & (\f|Equal0~6_combout\ & \f|Equal0~5_combout\)))
...
-- Equation(s):
-- \f|ctr~10_combout\ = (\f|Add0~38_combout\ & ((!\f|Equal0~4_combout\) # (!\f|Equal0~7_combout\)))
...
-- Equation(s):
-- \f|ctr~18_combout\ = (\f|Add0~46_combout\ & ((!\f|Equal0~4_combout\) # (!\f|Equal0~7_combout\)))
...
-- Equation(s):
-- \f|Equal0~0_combout\ = (!\f|ctr\(24) & (\f|ctr\(23) & (\f|ctr\(25) & \f|ctr\(22))))
...
-- Equation(s):
-- \f|Equal0~2_combout\ = (\f|ctr\(14) & (!\f|ctr\(16) & (\f|ctr\(15) & \f|ctr\(17))))
...
-- Equation(s):
-- \f|Equal0~1_combout\ = (\f|ctr\(19) & (\f|ctr\(20) & (\f|ctr\(21) & !\f|ctr\(18))))
...
-- Equation(s):
-- \f|Equal0~3_combout\ = (!\f|ctr\(10) & (\f|ctr\(12) & (!\f|ctr\(11) & \f|ctr\(13))))
...
-- Equation(s):
-- \f|Equal0~4_combout\ = (\f|Equal0~0_combout\ & (\f|Equal0~2_combout\ & (\f|Equal0~1_combout\ & \f|Equal0~3_combout\)))
...
-- Equation(s):
-- \c|Equal0~0_combout\ = (!\c|stop\(0) & (\c|stop\(2) & (\c|stop\(3) & \c|stop\(1))))
...
-- Equation(s):
-- \c|oled~0_combout\ = (\ct|ctlBus\(2) & (((!\c|stop\(4))) # (!\c|Equal0~0_combout\))) # (!\ct|ctlBus\(2) & (((\c|oled~q\))))
...
-- Equation(s):
-- \s|Equal0~2_combout\ = (\s|cctr\(10) & (!\s|cctr\(8) & (\s|cctr\(9) & !\s|cctr\(11))))
...
-- Equation(s):
-- \s|Equal0~3_combout\ = (!\s|cctr\(14) & (\s|cctr\(15) & (!\s|cctr\(12) & !\s|cctr\(13))))
...
-- Equation(s):
-- \c|Add1~2_combout\ = (\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(1) & ((\c|Add1~1\) # (GND))) # (!\c|ctr\(1) & (!\c|Add1~1\)))) # (!\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(1) & (!\c|Add1~1\)) # (!\c|ctr\(1) & (\c|Add1~1\ & VCC))))
-- \c|Add1~3\ = CARRY((\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(1)) # (!\c|Add1~1\))) # (!\ct|ctlBus[0]~2_combout\ & (\c|ctr\(1) & !\c|Add1~1\)))
...
-- Equation(s):
-- \c|ctr[2]~2_combout\ = (\ct|ctlBus\(2) & ((\c|ctr[2]~_emulated_q\ $ (\c|ctr[2]~1_combout\)))) # (!\ct|ctlBus\(2) & (\ct|ctlBus[0]~2_combout\))
...
-- Equation(s):
-- \c|Add1~6_combout\ = (\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(3) & ((\c|Add1~5\) # (GND))) # (!\c|ctr\(3) & (!\c|Add1~5\)))) # (!\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(3) & (!\c|Add1~5\)) # (!\c|ctr\(3) & (\c|Add1~5\ & VCC))))
-- \c|Add1~7\ = CARRY((\ct|ctlBus[0]~2_combout\ & ((\c|ctr\(3)) # (!\c|Add1~5\))) # (!\ct|ctlBus[0]~2_combout\ & (\c|ctr\(3) & !\c|Add1~5\)))
...
-- Equation(s):
-- \c|Add1~8_combout\ = ((\c|ctr[4]~6_combout\ $ (\ct|ctlBus[0]~2_combout\ $ (\c|Add1~7\)))) # (GND)
-- \c|Add1~9\ = CARRY((\c|ctr[4]~6_combout\ & ((!\c|Add1~7\) # (!\ct|ctlBus[0]~2_combout\))) # (!\c|ctr[4]~6_combout\ & (!\ct|ctlBus[0]~2_combout\ & !\c|Add1~7\)))
...
-- Equation(s):
-- \c|ctr[5]~9_combout\ = \c|ctr[4]~5_combout\ $ (\c|Add1~10_combout\)
...
\gd|disp2[1]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \gd|disp2[1]~4_combout\ = (\c|ctr[5]~8_combout\ & (\c|ctr\(3) $ (\c|ctr[2]~2_combout\ $ (\c|ctr\(1))))) # (!\c|ctr[5]~8_combout\ & (!\c|ctr\(1) & ((!\c|ctr[2]~2_combout\) # (!\c|ctr\(3)))))
...
PORT MAP (
	...
	datad => \c|ctr\(1),
	combout => \gd|disp2[1]~4_combout\);

-- Location: LCCOMB_X31_Y12_N12
\gd|disp2[1]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \gd|disp2[1]~2_combout\ = (\c|ctr\(1) & (!\c|ctr[5]~8_combout\ & (\c|ctr\(3) $ (!\c|ctr[2]~2_combout\)))) # (!\c|ctr\(1) & (\c|ctr[5]~8_combout\ $ (((\c|ctr\(3) & !\c|ctr[2]~2_combout\)))))
...
-- Equation(s):
-- \gd|disp2[1]~3_combout\ = (\c|ctr[4]~6_combout\ & (\gd|disp2[1]~4_combout\)) # (!\c|ctr[4]~6_combout\ & ((\gd|disp2[1]~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \gd|disp2[1]~4_combout\,
	datab => \c|ctr[4]~6_combout\,
	datac => \gd|disp2[1]~2_combout\,
...
-- Equation(s):
-- \s|o~6_combout\ = (!\s|ctr~q\ & ((\c|ctr[5]~8_combout\) # (\c|ctr[4]~6_combout\)))
...
-- Equation(s):
-- \gd|disp1[1]~0_combout\ = (\c|ctr\(3) & (!\c|ctr[5]~8_combout\ & (\c|ctr[4]~6_combout\))) # (!\c|ctr\(3) & (((\c|ctr[5]~8_combout\ & \c|ctr[4]~6_combout\)) # (!\c|ctr[2]~2_combout\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0100010010001111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr[5]~8_combout\,
...
-- Equation(s):
-- \s|o~7_combout\ = (\gd|disp2[1]~3_combout\ & ((\s|ctr~q\) # ((\s|o~6_combout\ & \gd|disp1[1]~0_combout\)))) # (!\gd|disp2[1]~3_combout\ & (\s|o~6_combout\ & (\gd|disp1[1]~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \gd|disp2[1]~3_combout\,
	datab => \s|o~6_combout\,
	datac => \gd|disp1[1]~0_combout\,
	datad => \s|ctr~q\,
...
-- Equation(s):
-- \s|o~13_combout\ = (\c|ctr[4]~6_combout\ & (!\c|ctr[5]~8_combout\ & (\c|ctr[2]~2_combout\ & !\c|ctr\(3)))) # (!\c|ctr[4]~6_combout\ & (\c|ctr[5]~8_combout\ & (\c|ctr[2]~2_combout\ $ (\c|ctr\(3)))))
...
-- Equation(s):
-- \s|o~12_combout\ = (\c|ctr[5]~8_combout\ & (\c|ctr[4]~6_combout\ & (!\c|ctr[2]~2_combout\ & !\c|ctr\(3)))) # (!\c|ctr[5]~8_combout\ & (\c|ctr[2]~2_combout\ & (\c|ctr[4]~6_combout\ $ (!\c|ctr\(3)))))
...
-- Equation(s):
-- \s|o~14_combout\ = (\s|ctr~q\ & ((\c|ctr\(1) & (\s|o~13_combout\ & !\s|o~12_combout\)) # (!\c|ctr\(1) & (!\s|o~13_combout\ & \s|o~12_combout\))))
...
-- Equation(s):
-- \s|o~8_combout\ = (\c|ctr[5]~8_combout\ & ((\c|ctr\(3)) # (!\c|ctr[4]~6_combout\)))
...
-- Equation(s):
-- \s|o~9_combout\ = (\c|ctr\(3) & (\c|ctr[2]~2_combout\ $ ((\c|ctr[4]~6_combout\)))) # (!\c|ctr\(3) & (!\c|ctr\(1) & (\c|ctr[2]~2_combout\ $ (!\c|ctr[4]~6_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0010100001101001",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr\(3),
...
-- Equation(s):
-- \s|o~15_combout\ = (\c|ctr[4]~6_combout\ & ((\c|ctr\(3) & (\c|ctr[2]~2_combout\)) # (!\c|ctr\(3) & ((\c|ctr\(1)))))) # (!\c|ctr[4]~6_combout\ & (\c|ctr[2]~2_combout\ & (\c|ctr\(3) $ (!\c|ctr\(1)))))
...
-- Equation(s):
-- \s|o~10_combout\ = (\c|ctr[5]~8_combout\ & ((\s|o~15_combout\))) # (!\c|ctr[5]~8_combout\ & (\s|o~9_combout\))
...
PORT MAP (
	...
	datad => \s|o~15_combout\,
	combout => \s|o~10_combout\);

-- Location: LCCOMB_X30_Y12_N28
\s|o~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~11_combout\ = (\s|ctr~q\ & ((\s|o~10_combout\))) # (!\s|ctr~q\ & (\s|o~8_combout\))
...
-- Equation(s):
-- \s|o~3_combout\ = (\c|ctr[5]~8_combout\ & ((\c|ctr[4]~6_combout\ & ((\c|ctr\(3)))) # (!\c|ctr[4]~6_combout\ & (!\c|ctr[2]~2_combout\)))) # (!\c|ctr[5]~8_combout\ & ((\c|ctr[4]~6_combout\ & (!\c|ctr[2]~2_combout\)) # (!\c|ctr[4]~6_combout\ & 
-- ((\c|ctr\(3))))))
...
-- Equation(s):
-- \s|o~2_combout\ = (\c|ctr[5]~8_combout\ & (!\c|ctr[4]~6_combout\ & (!\c|ctr[2]~2_combout\ & \c|ctr\(3)))) # (!\c|ctr[5]~8_combout\ & (\c|ctr[2]~2_combout\ & (\c|ctr[4]~6_combout\ $ (!\c|ctr\(3)))))
...
-- Equation(s):
-- \s|o~5_combout\ = (\s|ctr~q\ & (((!\s|o~4_combout\)))) # (!\s|ctr~q\ & (\s|o~3_combout\ $ (((\s|o~4_combout\) # (!\s|o~2_combout\)))))
...
-- Equation(s):
-- \dd|Mux6~0_combout\ = (\s|o\(1) & (!\s|o\(3) & ((!\s|o\(0)) # (!\s|o\(2))))) # (!\s|o\(1) & (\s|o\(3) $ ((\s|o\(2)))))
...
-- Equation(s):
-- \dd|Mux2~0_combout\ = (\s|o\(1) & (!\s|o\(3) & (!\s|o\(2) & !\s|o\(0))))
