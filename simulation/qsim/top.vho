...
SIGNAL \c|ctr[4]~4_combout\ : std_logic;
SIGNAL \c|oled~1_combout\ : std_logic;
SIGNAL \c|Add0~9\ : std_logic;
SIGNAL \c|Add0~10_combout\ : std_logic;
SIGNAL \c|ctr[5]~3_combout\ : std_logic;
SIGNAL \c|ctr[5]~_emulated_q\ : std_logic;
SIGNAL \c|ctr[5]~2_combout\ : std_logic;
SIGNAL \c|oled~0_combout\ : std_logic;
SIGNAL \c|oled~2_combout\ : std_logic;
SIGNAL \c|oled~3_combout\ : std_logic;
...
SIGNAL \s|o~18_combout\ : std_logic;
...
SIGNAL \s|o~17_combout\ : std_logic;
...
SIGNAL \s|di[1]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \f|ctr~15_combout\ = (\f|Add0~24_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|ctr~14_combout\ = (\f|Add0~26_combout\ & ((!\f|Equal0~4_combout\) # (!\f|Equal0~7_combout\)))
...
-- Equation(s):
-- \f|Equal0~3_combout\ = (!\f|ctr\(11) & (\f|ctr\(13) & (!\f|ctr\(10) & \f|ctr\(12))))
...
-- Equation(s):
-- \f|ctr~13_combout\ = (\f|Add0~28_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|ctr~12_combout\ = (\f|Add0~30_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|ctr~21_combout\ = (\f|Add0~40_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|ctr~20_combout\ = (\f|Add0~42_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|Equal0~1_combout\ = (!\f|ctr\(18) & (\f|ctr\(20) & (\f|ctr\(21) & \f|ctr\(19))))
...
-- Equation(s):
-- \f|Equal0~2_combout\ = (\f|ctr\(17) & (\f|ctr\(15) & (!\f|ctr\(16) & \f|ctr\(14))))
...
-- Equation(s):
-- \f|ctr~19_combout\ = (\f|Add0~44_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|ctr~17_combout\ = (\f|Add0~50_combout\ & ((!\f|Equal0~7_combout\) # (!\f|Equal0~4_combout\)))
...
-- Equation(s):
-- \f|Equal0~0_combout\ = (\f|ctr\(22) & (!\f|ctr\(24) & (\f|ctr\(23) & \f|ctr\(25))))
...
-- Equation(s):
-- \f|ctr~16_combout\ = (\f|Add0~14_combout\ & ((!\f|Equal0~4_combout\) # (!\f|Equal0~7_combout\)))
...
-- Equation(s):
-- \f|Equal0~6_combout\ = (\f|ctr\(4) & (\f|ctr\(2) & (\f|ctr\(5) & \f|ctr\(3))))
...
-- Equation(s):
-- \f|sclk~0_combout\ = \f|sclk~q\ $ (((\f|Equal0~7_combout\ & (\ct|ctlBus\(1) & \f|Equal0~4_combout\))))
...
-- Equation(s):
-- \ct|ctlBus[0]~3_combout\ = \ct|ctlBus[0]~1_combout\ $ (((!\ct|mode~q\ & \ct|stp~q\)))
...
\c|ctr[5]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[5]~1_combout\ = (GLOBAL(\ct|ctlBus[2]~clkctrl_outclk\) & (\c|ctr[5]~1_combout\)) # (!GLOBAL(\ct|ctlBus[2]~clkctrl_outclk\) & ((!\ct|ctlBus[0]~2_combout\)))
...
-- Equation(s):
-- \c|Add0~2_combout\ = (\c|ctr\(1) & ((\ct|ctlBus[0]~2_combout\ & ((\c|Add0~1\) # (GND))) # (!\ct|ctlBus[0]~2_combout\ & (!\c|Add0~1\)))) # (!\c|ctr\(1) & ((\ct|ctlBus[0]~2_combout\ & (!\c|Add0~1\)) # (!\ct|ctlBus[0]~2_combout\ & (\c|Add0~1\ & VCC))))
-- \c|Add0~3\ = CARRY((\c|ctr\(1) & ((\ct|ctlBus[0]~2_combout\) # (!\c|Add0~1\))) # (!\c|ctr\(1) & (\ct|ctlBus[0]~2_combout\ & !\c|Add0~1\)))
...
\c|ctr[1]~13\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[1]~13_combout\ = !\c|Add0~2_combout\
...
-- Equation(s):
-- \c|Add0~4_combout\ = ((\c|ctr[2]~8_combout\ $ (\ct|ctlBus[0]~2_combout\ $ (\c|Add0~3\)))) # (GND)
-- \c|Add0~5\ = CARRY((\c|ctr[2]~8_combout\ & ((!\c|Add0~3\) # (!\ct|ctlBus[0]~2_combout\))) # (!\c|ctr[2]~8_combout\ & (!\ct|ctlBus[0]~2_combout\ & !\c|Add0~3\)))
...
-- Equation(s):
-- \c|ctr[2]~7_combout\ = (GLOBAL(\ct|ctlBus[2]~clkctrl_outclk\) & (\c|ctr[2]~7_combout\)) # (!GLOBAL(\ct|ctlBus[2]~clkctrl_outclk\) & ((\ct|ctlBus[0]~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \c|ctr[2]~7_combout\,
	datac => \ct|ctlBus[0]~2_combout\,
	datad => \ct|ctlBus[2]~clkctrl_outclk\,
	combout => \c|ctr[2]~7_combout\);

-- Location: LCCOMB_X30_Y12_N4
\c|ctr[2]~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[2]~9_combout\ = \c|Add0~4_combout\ $ (\c|ctr[2]~7_combout\)
...
PORT MAP (
	...
	datad => \c|ctr[2]~7_combout\,
	combout => \c|ctr[2]~9_combout\);
...
\c|ctr[2]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[2]~8_combout\ = (\ct|ctlBus\(2) & ((\c|ctr[2]~_emulated_q\ $ (\c|ctr[2]~7_combout\)))) # (!\ct|ctlBus\(2) & (\ct|ctlBus[0]~2_combout\))
...
PORT MAP (
	...
	datad => \c|ctr[2]~7_combout\,
	combout => \c|ctr[2]~8_combout\);

-- Location: LCCOMB_X30_Y12_N22
\c|Add0~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|Add0~6_combout\ = (\c|ctr\(3) & ((\ct|ctlBus[0]~2_combout\ & ((\c|Add0~5\) # (GND))) # (!\ct|ctlBus[0]~2_combout\ & (!\c|Add0~5\)))) # (!\c|ctr\(3) & ((\ct|ctlBus[0]~2_combout\ & (!\c|Add0~5\)) # (!\ct|ctlBus[0]~2_combout\ & (\c|Add0~5\ & VCC))))
-- \c|Add0~7\ = CARRY((\c|ctr\(3) & ((\ct|ctlBus[0]~2_combout\) # (!\c|Add0~5\))) # (!\c|ctr\(3) & (\ct|ctlBus[0]~2_combout\ & !\c|Add0~5\)))
...
\c|ctr[3]~14\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[3]~14_combout\ = !\c|Add0~6_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \c|Add0~6_combout\,
	combout => \c|ctr[3]~14_combout\);
...
-- Equation(s):
-- \c|Add0~8_combout\ = ((\ct|ctlBus[0]~2_combout\ $ (\c|ctr[4]~4_combout\ $ (\c|Add0~7\)))) # (GND)
-- \c|Add0~9\ = CARRY((\ct|ctlBus[0]~2_combout\ & (\c|ctr[4]~4_combout\ & !\c|Add0~7\)) # (!\ct|ctlBus[0]~2_combout\ & ((\c|ctr[4]~4_combout\) # (!\c|Add0~7\))))
...
-- Equation(s):
-- \c|ctr[4]~5_combout\ = \c|Add0~8_combout\ $ (\c|ctr[5]~1_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \c|Add0~8_combout\,
	datad => \c|ctr[5]~1_combout\,
...
\c|ctr[4]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[4]~4_combout\ = (\ct|ctlBus\(2) & ((\c|ctr[5]~1_combout\ $ (\c|ctr[4]~_emulated_q\)))) # (!\ct|ctlBus\(2) & (!\ct|ctlBus[0]~2_combout\))
...
PORT MAP (
	dataa => \ct|ctlBus[0]~2_combout\,
	datab => \ct|ctlBus\(2),
	datac => \c|ctr[5]~1_combout\,
	datad => \c|ctr[4]~_emulated_q\,
	combout => \c|ctr[4]~4_combout\);

-- Location: LCCOMB_X30_Y12_N12
\c|oled~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|oled~1_combout\ = (\ct|ctlBus[0]~2_combout\ & ((!\c|ctr[2]~8_combout\) # (!\c|ctr[4]~4_combout\))) # (!\ct|ctlBus[0]~2_combout\ & ((\c|ctr[4]~4_combout\) # (\c|ctr[2]~8_combout\)))
...
PORT MAP (
	datab => \ct|ctlBus[0]~2_combout\,
	datac => \c|ctr[4]~4_combout\,
	datad => \c|ctr[2]~8_combout\,
	combout => \c|oled~1_combout\);

-- Location: LCCOMB_X30_Y12_N26
\c|Add0~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|Add0~10_combout\ = \c|ctr[5]~2_combout\ $ (\c|Add0~9\ $ (!\ct|ctlBus[0]~2_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr[5]~2_combout\,
	datad => \ct|ctlBus[0]~2_combout\,
	cin => \c|Add0~9\,
	combout => \c|Add0~10_combout\);

-- Location: LCCOMB_X30_Y12_N28
\c|ctr[5]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[5]~3_combout\ = \c|Add0~10_combout\ $ (\c|ctr[5]~1_combout\)
...
\c|ctr[5]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|ctr[5]~2_combout\ = (\ct|ctlBus\(2) & ((\c|ctr[5]~1_combout\ $ (\c|ctr[5]~_emulated_q\)))) # (!\ct|ctlBus\(2) & (!\ct|ctlBus[0]~2_combout\))
...
PORT MAP (
	...
	datab => \ct|ctlBus\(2),
	datac => \c|ctr[5]~1_combout\,
	datad => \c|ctr[5]~_emulated_q\,
	combout => \c|ctr[5]~2_combout\);

-- Location: LCCOMB_X30_Y12_N10
\c|oled~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|oled~0_combout\ = (\c|ctr\(1) & ((\c|ctr\(0)) # ((\ct|ctlBus[0]~2_combout\) # (!\c|ctr\(3))))) # (!\c|ctr\(1) & (((\c|ctr\(3)) # (!\ct|ctlBus[0]~2_combout\)) # (!\c|ctr\(0))))
...
PORT MAP (
	...
	datac => \ct|ctlBus[0]~2_combout\,
	datad => \c|ctr\(3),
	combout => \c|oled~0_combout\);

-- Location: LCCOMB_X30_Y12_N6
\c|oled~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|oled~2_combout\ = (\c|oled~1_combout\) # ((\c|oled~0_combout\) # (\c|ctr[5]~2_combout\ $ (\ct|ctlBus[0]~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \c|oled~1_combout\,
	datab => \c|ctr[5]~2_combout\,
	datac => \ct|ctlBus[0]~2_combout\,
	datad => \c|oled~0_combout\,
	combout => \c|oled~2_combout\);

-- Location: LCCOMB_X30_Y12_N8
\c|oled~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \c|oled~3_combout\ = (\ct|ctlBus\(2) & (\c|oled~2_combout\)) # (!\ct|ctlBus\(2) & ((\c|oled~q\)))
...
-- pragma translate_on
PORT MAP (
	datab => \c|oled~2_combout\,
	datac => \c|oled~q\,
	datad => \ct|ctlBus\(2),
	combout => \c|oled~3_combout\);
...
-- Equation(s):
-- \s|cctr~4_combout\ = (\s|Add0~20_combout\ & ((!\s|cctr\(16)) # (!\s|Equal0~4_combout\)))
...
-- Equation(s):
-- \s|Equal0~0_combout\ = (\s|cctr\(1) & (\s|cctr\(0) & (\s|cctr\(3) & \s|cctr\(2))))
...
-- Equation(s):
-- \s|Equal0~2_combout\ = (!\s|cctr\(11) & (!\s|cctr\(8) & (\s|cctr\(10) & \s|cctr\(9))))
...
-- Equation(s):
-- \s|sclk~0_combout\ = \s|sclk~q\ $ (((\s|Equal0~4_combout\ & \s|cctr\(16))))
...
-- Equation(s):
-- \s|o~3_combout\ = (\c|ctr[5]~2_combout\ & (\c|ctr\(3) & (!\c|ctr[4]~4_combout\ & !\c|ctr[2]~8_combout\))) # (!\c|ctr[5]~2_combout\ & (\c|ctr[2]~8_combout\ & (\c|ctr\(3) $ (!\c|ctr[4]~4_combout\))))
...
-- Equation(s):
-- \s|o~2_combout\ = (\c|ctr[2]~8_combout\ & (\c|ctr\(3) & (\c|ctr[4]~4_combout\ $ (!\c|ctr[5]~2_combout\)))) # (!\c|ctr[2]~8_combout\ & ((\c|ctr\(3)) # (\c|ctr[4]~4_combout\ $ (\c|ctr[5]~2_combout\))))
...
-- Equation(s):
-- \s|o~4_combout\ = \c|ctr\(1) $ (((\c|ctr\(0) & \s|ctr~q\)))
...
-- Equation(s):
-- \s|o~5_combout\ = (\s|ctr~q\ & (((!\s|o~4_combout\)))) # (!\s|ctr~q\ & (\s|o~2_combout\ $ (((\s|o~4_combout\) # (!\s|o~3_combout\)))))
...
\s|o~18\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~18_combout\ = (\c|ctr[5]~2_combout\ & (\c|ctr\(1) $ (\c|ctr\(3) $ (\c|ctr[2]~8_combout\)))) # (!\c|ctr[5]~2_combout\ & (!\c|ctr\(1) & ((!\c|ctr[2]~8_combout\) # (!\c|ctr\(3)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1000001100111001",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr[5]~2_combout\,
	...
	datac => \c|ctr\(3),
	datad => \c|ctr[2]~8_combout\,
	combout => \s|o~18_combout\);

-- Location: LCCOMB_X29_Y12_N2
\s|o~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~7_combout\ = (\c|ctr\(1) & (!\c|ctr[5]~2_combout\ & (\c|ctr\(3) $ (!\c|ctr[2]~8_combout\)))) # (!\c|ctr\(1) & (\c|ctr[5]~2_combout\ $ (((\c|ctr\(3) & !\c|ctr[2]~8_combout\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110001000010110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr[5]~2_combout\,
...
-- Equation(s):
-- \s|o~8_combout\ = (\c|ctr[4]~4_combout\ & ((\s|o~18_combout\) # ((!\s|ctr~q\)))) # (!\c|ctr[4]~4_combout\ & (\s|o~7_combout\ $ (((\s|o~18_combout\ & !\s|ctr~q\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \s|o~18_combout\,
	datab => \s|o~7_combout\,
	datac => \s|ctr~q\,
	datad => \c|ctr[4]~4_combout\,
	combout => \s|o~8_combout\);

-- Location: LCCOMB_X29_Y12_N0
\s|o~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~6_combout\ = (\c|ctr[5]~2_combout\ & (((!\c|ctr\(3))))) # (!\c|ctr[5]~2_combout\ & (\c|ctr[4]~4_combout\ & ((\c|ctr\(3)) # (!\c|ctr[2]~8_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \c|ctr[4]~4_combout\,
	datab => \c|ctr[2]~8_combout\,
	datac => \c|ctr\(3),
	datad => \c|ctr[5]~2_combout\,
	combout => \s|o~6_combout\);

-- Location: LCCOMB_X29_Y12_N20
\s|o~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~9_combout\ = (\s|o~8_combout\ & ((\s|o~6_combout\) # (\s|ctr~q\)))
...
-- Equation(s):
-- \s|o~11_combout\ = (\s|ctr~q\ & ((\c|ctr[2]~8_combout\) # ((!\c|ctr\(3) & \c|ctr\(1)))))
...
-- Equation(s):
-- \s|o~10_combout\ = (\s|ctr~q\ & ((\c|ctr\(1)) # (!\c|ctr[2]~8_combout\)))
...
-- Equation(s):
-- \s|o~12_combout\ = (\s|o~10_combout\ & (\c|ctr[5]~2_combout\ $ (((\c|ctr\(3)) # (!\s|o~11_combout\))))) # (!\s|o~10_combout\ & ((\s|o~11_combout\) # ((\c|ctr[5]~2_combout\ & !\c|ctr\(3)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0010111010110110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \s|o~13_combout\ = (\s|o~11_combout\ & (\c|ctr[5]~2_combout\ $ (((!\c|ctr\(3) & !\s|o~10_combout\))))) # (!\s|o~11_combout\ & (\c|ctr\(3) & (\c|ctr[5]~2_combout\ $ (\s|o~10_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1010010011000010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \s|o~11_combout\,
...
-- Equation(s):
-- \s|o~14_combout\ = \s|o~13_combout\ $ (((\s|o~12_combout\ & !\c|ctr[4]~4_combout\)))
...
-- Equation(s):
-- \s|o~15_combout\ = (\c|ctr[2]~8_combout\ & (!\c|ctr[5]~2_combout\ & (\c|ctr\(3) $ (!\c|ctr[4]~4_combout\)))) # (!\c|ctr[2]~8_combout\ & (!\c|ctr\(3) & (\c|ctr[4]~4_combout\ & \c|ctr[5]~2_combout\)))
...
-- Equation(s):
-- \s|o~16_combout\ = (\c|ctr\(3) & (!\c|ctr[2]~8_combout\ & (!\c|ctr[4]~4_combout\ & \c|ctr[5]~2_combout\))) # (!\c|ctr\(3) & (\c|ctr[2]~8_combout\ & (\c|ctr[4]~4_combout\ $ (\c|ctr[5]~2_combout\))))
...
\s|o~17\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|o~17_combout\ = (\s|ctr~q\ & ((\s|o~15_combout\ & (!\s|o~16_combout\ & !\c|ctr\(1))) # (!\s|o~15_combout\ & (\s|o~16_combout\ & \c|ctr\(1)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \s|o~15_combout\,
	datab => \s|o~16_combout\,
	datac => \s|ctr~q\,
	datad => \c|ctr\(1),
	combout => \s|o~17_combout\);
...
-- Equation(s):
-- \dd|Mux6~0_combout\ = (\s|o\(1) & (!\s|o\(3) & ((!\s|o\(2)) # (!\s|o\(0))))) # (!\s|o\(1) & ((\s|o\(2) $ (\s|o\(3)))))
...
-- Equation(s):
-- \dd|Mux2~0_combout\ = (!\s|o\(0) & (\s|o\(1) & (!\s|o\(2) & !\s|o\(3))))
...
\s|di[1]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \s|di[1]~feeder_combout\ = \s|ctr~q\
